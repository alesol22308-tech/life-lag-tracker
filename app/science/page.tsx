...
function SectionHeading({ id, title }: { id: string; title: string }) {
  return (
    <h2 id={id} className="text-2xl font-light text-gray-900 scroll-mt-24">
      {title}
    </h2>
  );
}
    ...
    <main className="min-h-screen px-4 py-12 sm:py-16 bg-gray-50">
      <div className="max-w-3xl mx-auto space-y-10">
        <header className="card space-y-4">
          <h1 className="text-4xl sm:text-5xl font-light text-gray-900">The Science Behind Life-Lag</h1>
          ...
          <div className="pt-2">
            <Link href="/home" className="text-sm text-slate-700 hover:text-slate-900 underline">
              Back to Home
            </Link>
          </div>
        </header>
        ...
        <section className="card space-y-4">
          ...
          <details className="pt-2">
            <summary className="text-sm text-slate-700 hover:text-slate-900 cursor-pointer">
        ...
        <section className="card space-y-6">
          ...
          <div className="space-y-2">
            <h3 id="why-weekly-checkin" className="text-lg font-medium text-gray-900 scroll-mt-24">
              Weekly check-in
            </h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div className="space-y-2">
            <h3 id="why-lag-score" className="text-lg font-medium text-gray-900 scroll-mt-24">
              Lag Score
            </h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div className="space-y-2">
            <h3 id="why-small-adjustments" className="text-lg font-medium text-gray-900 scroll-mt-24">
          ...
          <div className="space-y-2">
            <h3 id="why-trends" className="text-lg font-medium text-gray-900 scroll-mt-24">
              Trends over time
            </h3>
            <p className="text-gray-700 leading-relaxed">
