...
export const config = {
  matcher: [
    // Exclude static files, service workers, workbox files, and images
    '/((?!_next/static|_next/image|favicon\\.ico|sw\\.js|workbox-.*|manifest\\.json|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|woff|woff2|ttf|eot)$).*)',
  ],
};
